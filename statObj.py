...
class staticFilter():
    def __init__(self, shape):  
        ...
        self.state_variance = np.eye(1) * 343 #random value
        self.state_estimate = np.zeros(1)
        

    def reset(self, measurement):    
        self.state_estimate = measurement[:2]
    ...
    def update(self, dt, measurement):  
        ...
        return np.array([self.state_estimate[0][0],self.state_estimate[1][1]]) #otherwise it returns an 2x2 Array